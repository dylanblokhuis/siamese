  ...
  return (
    <div data-tauri-drag-region className='w-full h-[30px]'>
      <div className="w-32 grid grid-cols-3 ml-auto items-center h-full">
        ...
        <button className='flex justify-center items-center w-full h-full hover:bg-white/10' onClick={toggleMaximize}><svg  fill='currentColor' className='w-3 h-3' viewBox="0 0 10 10"><path d="M0,0v10h10V0H0z M9,9H1V1h8V9z" /></svg></button>
